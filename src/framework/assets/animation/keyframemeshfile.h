...
public:
	 ...
	 * @param transform a transformation matrix to be applied to every vertex
	 *                  loaded from the file
	 */
	KeyframeMeshFile(File *file, const Matrix4x4 &transform);
...
private:
	void Load(const Matrix4x4 &transform);
