...
namespace Gwen
{
	namespace Renderer
	{
		SpriteBatchRenderer::SpriteBatchRenderer(ContentManager *contentManager)
		{
			m_spriteBatch = NULL;
		...
		void SpriteBatchRenderer::DrawFilledRect(Gwen::Rect rect)
		{
			...
			m_spriteBatch->RenderFilledBox(rect.x, rect.y, rect.x + rect.w, rect.y + rect.h, renderColor);
		}
