...
public:
	 ...
	 * @param graphicsDevice the graphics device this camera is for
	 */
	...
	/**
	 * Viewport resize callback.
	 * @param left new left X coordinate of the viewport
	 * @param top new top Y coordinate of the viewport
	 * @param right new right X coordinate of the viewport
	 * @param bottom new bottom Y coordinate of the viewport
	 */
	virtual void OnResize(uint16_t left, uint16_t top, uint16_t right, uint16_t bottom);
...
protected:
	 ...
	 */
	void CalculateProjection(uint16_t left, uint16_t top, uint16_t right, uint16_t bottom);
