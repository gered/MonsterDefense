...
public:
	 ...
	 */
	virtual T* Get(const stl::string &name, const ContentParam *params) = 0;
	 ...
	 * @param <T> the type of content to be freed
	 */
	virtual void Free(const stl::string &name, const ContentParam *params) = 0;
