...
public:
	 ...
	 *                           issues while rendering
	 */
	GridTextureAtlas(const Texture *source, uint16_t tileWidth, uint16_t tileHeight, uint16_t tileBorder = 0, float texCoordEdgeOffset = TEXCOORD_EDGE_BLEED_OFFSET);
